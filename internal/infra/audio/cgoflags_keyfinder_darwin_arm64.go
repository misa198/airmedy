...
// cgoflags_ffmpeg_darwin_arm64.go — cgo merges all #cgo directives package-wide.

/*
#cgo CPPFLAGS: -I${SRCDIR}/keyfinder_libs/include -I${SRCDIR}/fftw3_libs/include
#cgo LDFLAGS: -L${SRCDIR}/keyfinder_libs/darwin/arm64 -L${SRCDIR}/fftw3_libs/darwin/arm64
