...
#cgo LDFLAGS: -L${SRCDIR}/ffmpeg_libs/windows/amd64 -L${SRCDIR}/aubio_libs/windows/amd64 -L${SRCDIR}/fftw3_libs/windows/amd64
#cgo LDFLAGS: -Wl,-Bstatic -lavfilter -lavformat -lavcodec -lswresample -lavutil -laubio -lfftw3f -Wl,-Bdynamic -lmfplat -lmf -lmfuuid -lstrmiids -lws2_32 -lsecur32 -lbcrypt -lole32 -loleaut32 -luuid -lwinmm -lversion
