...
#cgo LDFLAGS: -L${SRCDIR}/ffmpeg_libs/windows/arm64 -L${SRCDIR}/aubio_libs/windows/arm64
...
#cgo LDFLAGS: -Wl,-Bstatic -Wl,--start-group -lavfilter -lavformat -lavcodec -lswresample -lavutil -laubio -Wl,--end-group -Wl,-Bdynamic -lmfplat -lmf -lmfuuid -lstrmiids -lws2_32 -lsecur32 -lbcrypt -lole32 -loleaut32 -luuid -lwinmm -lversion
