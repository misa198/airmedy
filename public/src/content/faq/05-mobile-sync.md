...
<img src="/mobile-sync-no-device.webp" alt="Airmedy Mobile Sync screen with no connected devices" width="220">
<em>Open Sync and add a device.</em>

![Airmedy desktop Mobile settings with network choices and pairing QR code](/desktop-qr-code.webp)
<em>Choose the reachable network, then scan its QR code.</em>

<img src="/mobile-sync-scan.webp" alt="Airmedy Mobile QR scanner" width="220">
...
<img src="/mobile-sync-offline.webp" alt="Airmedy Mobile Sync screen showing a trusted desktop offline" width="220">
<em>Keep the offline Sync screen open.</em>

![Airmedy desktop Mobile settings with Broadcast signal](/desktop-broadcast.webp)
<em>Broadcast the pairing signal from desktop.</em>

<img src="/mobile-sync-online.webp" alt="Airmedy Mobile Sync screen showing a trusted desktop online" width="220">
...
![Airmedy desktop library sync selection screen](/desktop-sync-library-selector.webp)
<em>Choose what to sync.</em>

![Airmedy desktop library sync progress](/desktop-syncing-progress.webp)
<em>Follow progress on desktop.</em>

<img src="/mobile-syncing-progress.webp" alt="Airmedy Mobile library sync progress" width="220">
