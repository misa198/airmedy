const translations = {
    en: {
        ...
        screenshots: {
            ...
            lyrics: {
                ...
                line1: "Line of lyrics",
                line2: "Next line of lyrics",
                line3: "Wait for it..."
            }
        },
        faq: {
            ...
            gapless: {
                ...
                a: "Gapless playback and smart playlists are currently on our roadmap and will be arriving in future updates."
            },
            ffmpeg: {
    ...
    de: {
        ...
        faq: {
            ...
            gapless: {
                q: "Unterstützt es Gapless Playback?",
                a: "Gapless Playback und intelligente Playlists stehen derzeit auf unserer Roadmap und werden in zukünftigen Updates enthalten sein."
            },
            ffmpeg: {
    ...
    es: {
        ...
        screenshots: {
            ...
            lyrics: {
                ...
                line1: "Línea de letra",
                line2: "Siguiente línea de letra",
                line3: "Espera..."
            }
        },
        faq: {
            ...
            gapless: {
                q: "¿Admite reproducción sin pausas?",
                a: "La reproducción sin pausas y las listas de reproducción inteligentes están actualmente en nuestra hoja de ruta y llegarán en futuras actualizaciones."
            },
            ffmpeg: {
    ...
    fr: {
        ...
        screenshots: {
            ...
            lyrics: {
                ...
                line1: "Ligne de paroles",
                line2: "Ligne suivante",
                line3: "Attendez..."
            }
        },
        faq: {
            ...
            gapless: {
                q: "Supporte-t-il la lecture sans blanc ?",
                a: "La lecture sans blanc et les playlists intelligentes sont actuellement sur notre feuille de route et arriveront dans de futures mises à jour."
            },
            ffmpeg: {
    ...
    it: {
        ...
        faq: {
            ...
            gapless: {
                q: "Supporta la riproduzione senza pause?",
                a: "La riproduzione senza pause e le playlist intelligenti sono attualmente nella nostra tabella di marcia e arriveranno nei futuri aggiornamenti."
            },
            ffmpeg: {
    ...
    ja: {
        ...
        faq: {
            ...
            gapless: {
                q: "ギャップレス再生をサポートしていますか？",
                a: "ギャップレス再生とスマートプレイリストは現在ロードマップにあり、今後のアップデートで提供される予定です。"
            },
            ffmpeg: {
    ...
    ko: {
        ...
        faq: {
            ...
            gapless: {
                q: "끊김 없는 재생(Gapless)을 지원하나요?",
                a: "끊김 없는 재생과 스마트 플레이리스트는 현재 로드맵에 있으며 향후 업데이트에서 추가될 예정입니다."
            },
            ffmpeg: {
                q: "FFmpeg를 설치해야 하나요?",
    ...
    pt: {
        ...
        screenshots: {
            ...
            lyrics: {
                title: "Letras Sincronizadas",
                desc: "Modo de tela cheia imersivo com letras que se movem com a música.",
                line1: "Linha da letra",
                line2: "Próxima linha",
                line3: "Aguarde..."
            }
        },
        faq: {
            ...
            gapless: {
                q: "Suporta reprodução sem intervalos (gapless)?",
                a: "Reprodução sem intervalos e playlists inteligentes estão atualmente em nosso roteiro e chegarão em atualizações futuras."
            },
            ffmpeg: {
    ...
    ru: {
        ...
        faq: {
            ...
            gapless: {
                q: "Поддерживается ли воспроизведение без пауз?",
                a: "Воспроизведение без пауз и умные плейлисты в настоящее время находятся в разработке и появятся в будущих обновлениях."
            },
            ffmpeg: {
    ...
    th: {
        ...
        faq: {
            ...
            gapless: {
                q: "รองรับการเล่นแบบไร้ช่องว่าง (Gapless) หรือไม่?",
                a: "การเล่นแบบไร้ช่องว่างและเพลย์ลิสต์อัจฉริยะอยู่ในแผนงานของเราและจะมาพร้อมกับการอัปเดตในอนาคต"
            },
            ffmpeg: {
    ...
    vi: {
        ...
        screenshots: {
            ...
            lyrics: {
                ...
                line1: "Dòng lời bài hát",
                line2: "Dòng tiếp theo",
                line3: "Đang chờ..."
            }
        },
        faq: {
            ...
            gapless: {
                q: "Có hỗ trợ phát nhạc không khoảng lặng (gapless) không?",
                a: "Phát nhạc không khoảng lặng và danh sách phát thông minh hiện đang nằm trong lộ trình của chúng tôi và sẽ sớm ra mắt."
            },
            ffmpeg: {
    ...
    zh: {
        ...
        faq: {
            ...
            gapless: {
                q: "支持无缝播放吗？",
                a: "无缝播放和智能播放列表目前已列入我们的路线图，并将在未来的更新中推出。"
            },
            ffmpeg: {
                q: "我需要安装 FFmpeg 吗？",
