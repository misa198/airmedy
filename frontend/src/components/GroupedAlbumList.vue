  ...
  <div class="space-y-12 pb-12">
    <div v-for="group in groupedAlbums" :key="group.album?.id || 'unknown'" class="space-y-4">
      ...
      <div class="flex items-end gap-6 pr-2">
        <div
          class="w-32 h-32 md:w-40 md:h-40 rounded-xl shadow-xl overflow-hidden ring-1 ring-white/8 bg-white/5 flex-shrink-0 group relative">
      ...
      <div class="rounded-xl overflow-hidden ring-1 ring-white/[0.06]"
