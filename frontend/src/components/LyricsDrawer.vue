...
const isSynced = computed(() => !!lyricsContent.value && LRC_PATTERN.test(lyricsContent.value))
...
<template>
  <div class="h-full w-full bg-background flex flex-col">
    ...
    <div class="flex-1 overflow-hidden">
      ...
      <!-- Synced view -->
      <div
        v-else-if="effectiveViewType === 'synced'"
        ref="scrollContainer"
