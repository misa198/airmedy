...
<template>
  <div class="relative group">
    <RouterLink :to="to"
      class="flex min-w-0 items-center gap-3 px-3 py-2 rounded-lg transition-colors text-foreground opacity-80 hover:text-foreground hover:bg-foreground/[0.05]"
