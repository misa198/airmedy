...
<template>
  <div class="h-full flex flex-col bg-background overflow-hidden">
    ...
    <div v-else-if="artist" class="flex-1 overflow-y-auto">
      <!-- Artist Hero Section -->
      <div class="p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center bg-gradient-to-b from-accent/30 to-background border-b">
        <div class="w-40 h-40 md:w-56 md:h-56 rounded-full shadow-2xl overflow-hidden border-4 border-background bg-muted flex-shrink-0">
        ...
        <div class="flex-1 text-center md:text-left space-y-4">
          <div class="space-y-1">
            ...
            <div class="flex flex-wrap items-center justify-center md:justify-start gap-4 text-muted-foreground">
