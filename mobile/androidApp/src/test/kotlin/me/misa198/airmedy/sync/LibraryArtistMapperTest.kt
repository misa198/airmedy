...
class LibraryArtistMapperTest {
    ...
    fun groupsAlbumsByManifestIdAndResolvesAlbumArtwork() {
        val albums = libraryAlbumsFrom(
            tracks = listOf(
                row("""{"album":{"id":"album-a","title":"Album A","sort_title":"A Album","year":2001,"artwork_key":"album-art","created_at":"2026-02-01T00:00:00Z"},"album_artists":[{"name":"Artist A","sort_name":"A Artist"}]}"""),
